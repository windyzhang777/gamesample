...
// import BuyCandy from '../components/screens/BuyCandy';
...
import CustomizationMessageSelector from '../components/CustomizationMessageSelector';
...
export default function resolveNative(componentName: string, props?: any) {
  switch (componentName) {
    ...
    case 'CustomizationItemList':
      return <CustomizationItemList {...props} />;
    ...
    case 'CustomizationMessageSelector':
      return <CustomizationMessageSelector {...props} />;
    default:
      console.log('componentName not found : ', componentName);
