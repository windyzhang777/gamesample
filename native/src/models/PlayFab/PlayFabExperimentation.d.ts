  ...
  export interface IPlayFabExperimentation {
    ...
    CreateExperiment(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabExperimentationModels.CreateExperimentResult
      > | null,
    ): void;
    ...
    GetLatestScorecard(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabExperimentationModels.GetLatestScorecardResult
      > | null,
    ): void;
    ...
    GetTreatmentAssignment(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabExperimentationModels.GetTreatmentAssignmentResult
      > | null,
    ): void;
