  ...
  export interface IPlayFabAdmin {
    ...
    AddUserVirtualCurrency(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.ModifyUserVirtualCurrencyResult
      > | null,
    ): void;
    ...
    CheckLimitedEditionItemAvailability(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.CheckLimitedEditionItemAvailabilityResult
      > | null,
    ): void;
    ...
    CreatePlayerStatisticDefinition(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.CreatePlayerStatisticDefinitionResult
      > | null,
    ): void;
    ...
    DeleteMasterPlayerAccount(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.DeleteMasterPlayerAccountResult
      > | null,
    ): void;
    ...
    // Deletes an existing Player src Secret Key. It may take up to 5 minutes for this delete to be reflected after this API
    // returns.
    ...
    GetActionsOnPlayersInSegmentTaskInstance(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.GetActionsOnPlayersInSegmentTaskInstanceResult
      > | null,
    ): void;
    ...
    GetCloudScriptTaskInstance(
      request: PlayFabAdminModels.GetTaskInstanceRequest | null,
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.GetCloudScriptTaskInstanceResult
      > | null,
    ): void;
    ...
    // Returns all Player src Secret Keys including disabled and expired.
    ...
    GetPlayerStatisticDefinitions(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.GetPlayerStatisticDefinitionsResult
      > | null,
    ): void;
    ...
    GetPlayerStatisticVersions(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.GetPlayerStatisticVersionsResult
      > | null,
    ): void;
    ...
    IncrementLimitedEditionItemAvailability(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.IncrementLimitedEditionItemAvailabilityResult
      > | null,
    ): void;
    ...
    IncrementPlayerStatisticVersion(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.IncrementPlayerStatisticVersionResult
      > | null,
    ): void;
    ...
    ModifyMatchmakerGameModes(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.ModifyMatchmakerGameModesResult
      > | null,
    ): void;
    ...
    // https://docs.microsoft.com/rest/api/playfab/admin/src-group-data/setpublisherdata
    SetPublisherData(
    ...
    // Updates a existing Player src Secret Key. It may take up to 5 minutes for this update to become generally available
    ...
    UpdatePlayerStatisticDefinition(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.UpdatePlayerStatisticDefinitionResult
      > | null,
    ): void;
    ...
    UpdateUserTitleDisplayName(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabAdminModels.UpdateUserTitleDisplayNameResult
      > | null,
    ): void;
  }
}
...
declare module PlayFabAdminModels {
  ...
  export interface CreatePlayerSharedSecretResult extends PlayFabModule.IPlayFabResultCommon {
    // The player src secret to use when calling Client/GetTitlePublicKey
    SecretKey?: string;
  }
