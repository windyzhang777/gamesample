declare module PlayFabClientModule {
  export interface IPlayFabClient {
    ...
    // in the group can add new members. src Groups are designed for sharing data between a very small number of players,
    // please see our guide: https://docs.microsoft.com/gaming/playfab/features/social/groups/using-src-group-data
    // https://docs.microsoft.com/rest/api/playfab/client/src-group-data/addsharedgroupmembers
    ...
    // group. Upon creation, the current user will be the only member of the group. src Groups are designed for sharing data
    // between a very small number of players, please see our guide:
    // https://docs.microsoft.com/gaming/playfab/features/social/groups/using-src-group-data
    // https://docs.microsoft.com/rest/api/playfab/client/src-group-data/createsharedgroup
    CreateSharedGroup(
    ...
    // Retrieves data stored in a src group object, as well as the list of members in the group. Non-members of the group
    // may use this to retrieve group data, including membership, but they will not receive data for keys marked as private.
    // src Groups are designed for sharing data between a very small number of players, please see our guide:
    // https://docs.microsoft.com/gaming/playfab/features/social/groups/using-src-group-data
    // https://docs.microsoft.com/rest/api/playfab/client/src-group-data/getsharedgroupdata
    GetSharedGroupData(
    ...
    GetWindowsHelloChallenge(
      ...
      callback: PlayFabModule.ApiCallback<
        PlayFabClientModels.GetWindowsHelloChallengeResponse
      > | null,
    ): void;
    ...
    // https://docs.microsoft.com/rest/api/playfab/client/src-group-data/removesharedgroupmembers
    ...
    // Regardless of the permission setting, only members of the group can update the data. src Groups are designed for
    // sharing data between a very small number of players, please see our guide:
    // https://docs.microsoft.com/gaming/playfab/features/social/groups/using-src-group-data
    // https://docs.microsoft.com/rest/api/playfab/client/src-group-data/updatesharedgroupdata
...
declare module PlayFabClientModels {
  ...
  export interface GetTitlePublicKeyRequest extends PlayFabModule.IPlayFabRequestCommon {
    ...
    // title has been selected.
    TitleId: string;
    // The src secret key for this title
