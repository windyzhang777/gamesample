...
import {post, executeCloudScript} from 'shared/utils/api';
import {get} from 'shared/utils/object';
import {cacheContent} from '../content/actions';
import {Door, CatalogResponse, Tags, ItemClass} from 'shared/models/Door';
import {Decoration} from '../../models/Decoration';
import {DoorCustomizations} from './reducer';
 ...
 * @param payload
 */
export function* saveDoor({payload}: {payload: DoorCustomizations}) {
  try {
